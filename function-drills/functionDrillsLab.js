...
function bigOrSmall(arr) {
  ...
  let arrayEvaluator = answers.slice();
...
// can use .includes without a for loop
...
// }
// let totalFrogs2 = buyFrogs2(20)
// console.log(totalFrogs2)

const buyFrogs2 = gold => console.log(Math.floor(gold/3))
buyFrogs2(50)
...
/*
  ...
  write logic to determine if the array is in ascending order. The function should return true, if it is sorted in ascending order, false if it is not. 
